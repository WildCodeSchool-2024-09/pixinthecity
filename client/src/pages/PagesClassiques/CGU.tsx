  ...
  return (
    <>
      <div className="cgu_text">
        <h1 id="titre_cgu">Conditions générales d'utilisation</h1>
        <p>En vigueur au 28/01/2025</p>
        <br />
        <p>
          Les présentes conditions générales d'utilisation (dites{" "}
          <strong>« CGU »</strong>) ont pour objet l'encadrement juridique des
          modalités de mise à disposition du site et des services par street_art
        ...
        <p>
          ...
          le site. Street_art se réserve le droit de modifier unilatéralement et
        ...
        <p>
          ...
          Adresse email : pixinthecity@gmail.com. Le Directeur de la publication
          est : la wild Code school.
        </p>
        <br />
        <p>
          L'hébergeur du site street_art est la société Wild code school, dont
          le siège social est situé au 17 rue Delandine 69002 Lyon, avec le
        ...
        <p>
          ...
          Upload (chargement) de photos street art depuis un mobile/tablette ou
          ordinateur. Le site est accessible gratuitement en tout lieu à tout
        ...
        <p>
          ...
          l'aide de son adresse email et de son mot de passe créé lors de son
        ...
        <p>
          ...
          responsabilité de street_art. Dans ces cas, l’Utilisateur accepte
        ...
        <br />
        <p>
          La marque street_art est une marque déposée par pixinthecity. Toute
        ...
        <p>
          ...
          le site street_art ne peut être tenu responsable de la modification
        ...
        <p>
          ...
          Il assume les risques liés à l'utilisation de son mail et mot de
          passe. Le site décline toute responsabilité.
        </p>
        <br />
        <p>
          Le site street_art ne peut être tenu pour responsable d’éventuels
        ...
        <p>
          ...
          street_art. Ce dernier n’a pas de contrôle sur les pages web sur
        ...
        <p>
          ...
          qui sont nécessaires à l’utilisation du site street_art.
        </p>
        <br />
        <p>
          Les cookies ne contiennent pas d’information personnelle et ne peuvent
          pas être utilisés pour identifier quelqu’un. Un cookie contient des
          données cryptées et donc anonymes. Ces cookies expirent à la fin de la
          visite de l’Utilisateur, d’autres restent.
        </p>
        <br />
        <p>
          L’information contenue dans les cookies est utilisée pour
          l’authentification sécurisée sur le site street_art.
        </p>
        <br />
        <p>
        ...
        <br />
        <p>
          L’utilisateur est sollicité pour la géolocalisation lors de l’upload
          de la photo. Celui-ci peut accepter ou refuser sans que cela perturbe
          la publication des photos sur le site (des coordonnées aléatoires
