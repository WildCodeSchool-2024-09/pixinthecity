  ...
  return (
    <>
      ...
      <ul>
        ...
        <li>
          Globe-Trotter Urbain : Soumettre des œuvres dans 2 villes différentes.
      ...
      <ul>
        <li>
          ...
          <img src="\src\assets\images\decorateur_rare.jpg" alt="decouverte" />
        </li>
        <li>
      ...
      <p>
        ...
        contributeurs en fonction du total de points accumulés. Plus vous aurez
        de points plus vous serez au sommet de la pyramide :
      </p>
      <ul>
